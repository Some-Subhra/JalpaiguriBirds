$(function(){
	...
	/*$(".scroll-right").click(function(){
		setTimeout(function(){
		 $(".sticky-wrap").scrollLeft($(".sticky-wrap").scrollLeft() + 35); 
		}, 100);
	});
	...
	var timeout, clicker = $('.scroll-right');
	...
	var timeout, clicker = $('.scroll-left');
	...
	$(function () {
             ...
             $win.scroll(function () {
                 if ($win.scrollTop()
                               >= $(".fixed-header").offset().top && $(window).width() > 767) {
                   $(".scroll-right").css({
										   'position' : 'fixed',
										   'top' : '10px',
										   'right' : '5px'
